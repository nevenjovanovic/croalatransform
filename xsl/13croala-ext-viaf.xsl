...
<xsl:stylesheet xmlns:tei="http://www.tei-c.org/ns/1.0"
    ...
    <xsl:variable name="ime" select="document('/home/neven/rad/croala-r/biblio/ext-viaf3.xml')/a"/>
    
    <xsl:key name="viafkey" match="ref" use="@ime"/>
    
    
    
    <xsl:template match="//tei:body//tei:biblStruct[@type='externum']/tei:monogr/tei:author[not(tei:ref)]">
