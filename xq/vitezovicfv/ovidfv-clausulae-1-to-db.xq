(: write single-word repeated clausulae, with number of repetitions, to a db -- for Ovid :)
(: order descending :)
...
return db:create("ovidfvrep1", $body , "ovidclausulae1rep.xml", map { 'ftindex': true(), 'intparse': true(), 'stripns': true() })