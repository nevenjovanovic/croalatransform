(: write two-word repeated clausulae, with number of repetitions, to a db -- for Ovid :)
(: order descending :)
...
return db:create("ovidfvrep2", $body , "ovidclausulae2rep.xml", map { 'ftindex': true(), 'intparse': true(), 'stripns': true() })