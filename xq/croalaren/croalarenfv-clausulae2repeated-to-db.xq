(: write repeated two-word clausulae, with number of repetitions, to a db -- for croala ren :)
(: order descending :)
...
return db:create("croalafvrenrep2", $body , "croalaclausulaeren2rep.xml", map { 'ftindex': true(), 'intparse': true(), 'stripns': true() })