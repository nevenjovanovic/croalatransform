...
declare function croala:wordsauct () {
...
(:~
 ...
 :)
declare
  %rest:path("/verba/auctores")
  %rest:GET
  function page:verbaqauctores()
{
...
<p><a href="http://www.ffzg.unizg.hr/klafil/croala">CroALa</a>, { current-date() }. Quaerimus verba quaedam apud auctores collectionum CroALa et LatTy. Verba sunt haec: { string-join(croala:quaedam(), ', ')}.</p>
