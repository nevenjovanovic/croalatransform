...
(: choose word count range and period :)
...
declare function croala:wc4 ($period,$lo,$hi) { 
...
(:~
 ...
 :)
declare
  %rest:path("/numdiv/{$period}/{$lo}/{$hi}")
  %rest:GET
  function page:quotverbadiv4($period,$lo,$hi)
{
  (: HTML template starts here :)

<html>
<head><title>CroALa &amp; LatTy: div in utraque 3</title>
...
<body text="#000000">
<h1>CroALa &amp; LatTy: div in utraque, aetate {$period}, verborum {$lo}-{$hi}</h1>

<p><a href="http://www.ffzg.unizg.hr/klafil/croala">CroALa</a>, { current-date() }. Quaeritur in collectionibus CroALa et LatTy, in aetate {$period}.</p>
<p>Functio nominatur: {rest:uri()}.</p>
    { croala:wc4($period,$lo,$hi) }
     <p/>
<hr/>
<div>
