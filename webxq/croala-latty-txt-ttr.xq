...
declare function croala:txtttr ($collection) { for $i in collection($collection)//*:text[not(descendant::*:text)]
...
(:~
 ...
 :)
declare
  %rest:path("/ttrtxt/{$auct}")
  %rest:GET
  function page:ttrtxt(
    $auct)
{
...
<p><a href="http://www.ffzg.unizg.hr/klafil/croala">CroALa</a>, { current-date() }. Quaerimus verba typica et occurrentia in textibus collectionis {$auct}.</p>
