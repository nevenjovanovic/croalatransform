...
(: list word count in texts, type count, type-token ratio :)
declare function croala:txtttr () { 
...
element td {
element a {
attribute href {"http://solr.ffzg.hr/basex/node/" || db:name($i) || "/" || db:node-pre($i) },
db:path($i)  } } ,
element td { 
attribute class {"tok"},
$wc } ,
...
(:~
 ...
 :)
declare
  %rest:path("/ttrtxt2/croalalatty")
  %rest:GET
  function page:ttrtxt2()
{
...
<p><a href="http://www.ffzg.unizg.hr/klafil/croala">CroALa</a>, { current-date() }. Quaerimus verba typica et occurrentia in textibus collectionum CroALa et LatTy.</p>
