...
(: croalabib-drama-bibliorefs-page, practising TDD w/BaseX :)
(: show secondary ref title and referring drama ids :)
...
(:~
 ...
 :)
declare
  %rest:path("/dramabib-titleref/{$refid}")
  %rest:GET
  function page:dramabibrefs-page($refid)
{
