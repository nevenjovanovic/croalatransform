...
(:~
 ...
 :)
declare
  %rest:path("croalalattyversussaec")
  %rest:GET
  function page:clltvsc()
{
  (: HTML template starts here :)

<html>
<head><title>CroALa &amp; LatTy: versus per saecula</title>
...
<div class="jumbotron">
<h1><span class="glyphicon glyphicon-th" aria-hidden="true"></span> CroALa &amp; LatTy: <small>versus per saecula</small></h1>
