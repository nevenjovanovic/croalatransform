...
declare function croala:authco($collection) {
...
(:~
 ...
 :)
declare
  %rest:path("/auctores/periodi")
  %rest:GET
  function page:croalalattyauctperiod()
{
...
<div class="jumbotron">
<h1><span class="glyphicon glyphicon-th" aria-hidden="true"></span> Croatiae et Tyrolidis auctores Latini:<small> per saecula</small></h1>
...
element h2 { $bibs || " (" || croala:authco($bibs) || ")" },
element table { 
...
element tbody { 
if ($bibs="croalabib") then for $i in (1 to 6) return 
element tr {
  element td { "N/A"},
  element td { "N/A"}
} 
