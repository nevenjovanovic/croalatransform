...
(: get sentence with a specific @corresp :)
...
(:~
 ...
 :)
declare
  %rest:path("/homer/sent/{$urn}")
  %rest:GET
  function page:homersent2($urn)
{
...
<div class="container">
<div class="jumbotron">
<h1><span class="glyphicon glyphicon-th" aria-hidden="true"></span> Homer grčki  i hrvatski <small>- rečenica {$urn}</small></h1>
