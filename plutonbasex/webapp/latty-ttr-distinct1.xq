...
(: for certain period, return ttr's and other data in both db's, using cl-idx db :)
...
declare function croala:ttrdist2 ($aet) {
  let $dbidx := "cl-idx"
...
<html>
<head><title>CroALa &amp; LatTy: TTR in aetate</title>
...
<p><a href="http://www.ffzg.unizg.hr/klafil/croala">CroALa</a>, { current-date() }. Quaerimus TTR (rationes lemmatum et verborum) in aetate {$aet} in elementis div collectionum CroALa et LatTy.</p>
